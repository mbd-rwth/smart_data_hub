...
def load_site_property(site_files_path):
    ...
    for filepath in site_files_path:
        ...
        for rock_layer, rock_data in content.items():
            ...
            site_entry["geometry_orientation_data_path"] = geometry_orientation_data_path
...
def combine_rock_site_property():
    ...
    yaml_rock_property_paths = [path for path in yaml_property_paths if default_path not in path]
